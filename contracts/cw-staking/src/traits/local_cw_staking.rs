...
pub trait LocalCwStaking: AbstractNameService + Execution {
    ...
    fn resolve_stake(
        ...
        let staking_address =
            provider.lp_token_staking_contract_address(deps, ans.host(), lp_token.name.as_str())?;
    ...
    fn resolve_claim(
        ...
        let staking_address =
            provider.lp_token_staking_contract_address(deps, ans.host(), lp_token_name.as_str())?;
