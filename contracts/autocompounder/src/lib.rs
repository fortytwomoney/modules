...
mod test_common {
    ...
    use abstract_cw_staking::msg::{
        StakeResponse, StakingInfoResponse, StakingInfo,StakingQueryMsg, StakingTarget,
    };
    ...
    use abstract_testing::{
        ...
        prelude::{AbstractMockQuerierBuilder, TEST_ANS_HOST, TEST_DEX, TEST_VERSION_CONTROL, TEST_ACCOUNT_ID},
                ...
                match from_binary(msg).unwrap() {
                    abstract_cw_staking::msg::QueryMsg::Module(StakingQueryMsg::Info {
                        ...
                        let resp = StakingInfoResponse {
                            infos: vec![StakingInfo { staking_target:   StakingTarget::Contract(Addr::unchecked(
                                    "staking_addr",
                                )) ,
