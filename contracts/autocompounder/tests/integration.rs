...
fn paginate_all_claims(vault: &Vault<MockBech32>) -> Result<Vec<(Addr, Vec<Claim>)>, anyhow::Error> {
...
fn paginate_all_pending_claims(vault: &Vault<MockBech32>) -> Result<Vec<(Addr, Uint128)>, anyhow::Error> {
